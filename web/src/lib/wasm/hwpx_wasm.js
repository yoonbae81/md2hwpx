/* @ts-self-types="./hwpx_wasm.d.ts" */

/**
 * 마크다운 + template.hwpx 바이트를 HWPX 바이트로 변환한다.
 * 변형 선택은 웹에서는 사용하지 않는다(빈 목록).
 * @param {string} source_md
 * @param {Uint8Array} template_bytes
 * @returns {Uint8Array}
 */
export function compile_hwpx(source_md, template_bytes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(source_md, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(template_bytes, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        wasm.compile_hwpx(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function convert_hwpx(input_bytes, label) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.convert_hwpx(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hwpx_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
